...
from app.repository.publicacion_repo import PublicacionRepository
...
class AppController:
    ...
    def _setup_pages(self):
        ...
        # -------------------------
        # DEPENDENCIAS PUBLICACION
        # -------------------------
        publicacion_repo = PublicacionRepository()

        publicacion_service = PublicacionService(
            publicacion_repo
        )

        publicacion = PublicacionPage(publicacion_service, stacked)
    ...
    def _setup_connections(self):
        ...
        self.home.ui.btnPublicacion.clicked.connect(
            lambda: self.show_page("publicacion")
        )
